...
# Weights_200_conv1d_samepad_1_128shortrun
identifier_post_training = "BS_" + str(generator_batch_size) + "_GP_128_LLR"
# identifier_pre_training = "_conv1d_samepad_" + str(num_epochs) + "_" + str(generator_batch_size) + "shortrun"
identifier_pre_training = "BS_" + str(
    generator_batch_size) + "_GP_128_MLR"  # for now, make hardcode what you want to finetune
# @@@@@@@@@@@@@@ RELATIVE PATHS @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
# Base_Path = "./"
# image_path = "./images/"
# train_path = "./train/"
