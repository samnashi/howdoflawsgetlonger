...
identifier_pre_training = "BS_" + str(generator_batch_size) + "_GP_128_MLR"  #for now, make hardcode what you want to finetune
#@@@@@@@@@@@@@@ RELATIVE PATHS @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
# Base_Path = "./"
# image_path = "./images/"
# train_path = "./train/"
...
if finetune==False:
    ...
    weights_present_indicator = os.path.isfile('Weights_' + str(prev_num_sequence_draws)  + identifier_pre_training + '.h5')
...
if (finetune == False and weights_present_indicator == False and test_only == False) or (finetune == True and weights_present_indicator == True):
    ...
    for i in range(0, num_sequence_draws):
        ...
        if finetune == True:  # load the weights
            finetune_init_weights_filename = 'Weights_' + str(prev_num_sequence_draws) + identifier_pre_training + '.h5'  # hardcode the previous epoch number UP ABOVE
