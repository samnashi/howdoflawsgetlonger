...
sequence_circumnavigation_amt = 3 #TODO add the boilerplate to make this similar to the other models.
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
out = reference_bigru(input_tensor=g)
