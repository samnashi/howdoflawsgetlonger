...
CHUNKER_BATCH_TRAVERSAL_SIZE = 64
...
#initialize two sklearn metrics
    ...
    chunker_proto_preds = generator_chunker(array_raw=preds_array, chunker_batch_size=CHUNKER_BATCH_TRAVERSAL_SIZE, start_at=0,
                                            scaler_active=False)
    chunker_proto_label = generator_chunker(array_raw=label_test_array,chunker_batch_size=CHUNKER_BATCH_TRAVERSAL_SIZE,start_at=0,
