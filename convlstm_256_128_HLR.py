...
# Weights_200_conv1d_samepad_1_128shortrun
identifier_post_training = "BS_" + str(generator_batch_size) + "_GP_128_HLR"
...
if finetune == False:
    ...
    weights_present_indicator = os.path.isfile('Weights_' + str(num_sequence_draws) + identifier_pre_training + '.h5')
    ...
    for i in range(0, num_sequence_draws):
        ...
        if finetune == True:  # load the weights
            finetune_init_weights_filename = 'Weights_' + str(
                num_sequence_draws) + identifier_pre_training + '.h5'  # hardcode the previous epoch number UP ABOVE
