...
prev_num_sequence_draws = 300  # prev. times trining corpus sampled
...
# Weights_200_conv1d_samepad_1_32shortrun
identifier_post_training = "BS_" + str(generator_batch_size) + "_GP_32_MLR"
# identifier_pre_training = "_conv1d_samepad_" + str(num_epochs) + "_" + str(generator_batch_size) + "shortrun"
identifier_pre_training = "BS_" + str(generator_batch_size) + "_GP_32_HLR"  # for now, make hardcode what you want to finetune
# @@@@@@@@@@@@@@ RELATIVE PATHS @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
# Base_Path = "./"
# image_path = "./images/"
# train_path = "./train/"
